...
// Function to handle opening the text modal
const handleViewTextContent = (content) => {
...
//update Content Feed for 2nd time onwards
      if (response.data.status === 'success') {
...
{content.contentType === 'TEXT' && (
  <button 
    className="action-btn view-btn"
    onClick={() => handleViewTextContent(content.content)}
  >
    View Content
  </button>
)}
